...
export default async function EditarEntradaPage({
  ...
  const actualizar = actualizarEntrada.bind(null, locale, entrada.id);
        ...
        <div className="flex items-center justify-between gap-4 p-5">
          ...
          <div className="flex items-center gap-2.5">
            <button
              type="submit"
              form={formId}
              className="border-2 border-ink bg-secondary-purple px-4 py-2 font-pixel text-xs tracking-wide text-background shadow-[3px_3px_0_var(--ink)] transition-[transform,filter] hover:brightness-95 active:translate-x-0.5 active:translate-y-0.5 active:shadow-none"
            >
